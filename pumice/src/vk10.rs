...
crate::enum_impl! {
    ...
    DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL, DEPTH_ATTACHMENT_OPTIMAL,
    DEPTH_READ_ONLY_OPTIMAL, STENCIL_ATTACHMENT_OPTIMAL, STENCIL_READ_ONLY_OPTIMAL,
    READ_ONLY_OPTIMAL, ATTACHMENT_OPTIMAL, PRESENT_SRC_KHR, VIDEO_DECODE_DST_KHR,
    VIDEO_DECODE_SRC_KHR, VIDEO_DECODE_DPB_KHR, SHARED_PRESENT_KHR,
    FRAGMENT_DENSITY_MAP_OPTIMAL_EXT, FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR,
    VIDEO_ENCODE_DST_KHR, VIDEO_ENCODE_SRC_KHR, VIDEO_ENCODE_DPB_KHR,
...
crate::enum_impl! {
    AttachmentLoadOp : i32, LOAD, CLEAR, DONT_CARE, NONE_EXT
}
...
crate::enum_impl! {
    AttachmentStoreOp : i32, STORE, DONT_CARE, NONE
}
...
crate::enum_impl! {
    ImageTiling : i32, OPTIMAL, LINEAR, DRM_FORMAT_MODIFIER_EXT
}
...
crate::enum_impl! {
    ...
    INLINE_UNIFORM_BLOCK, ACCELERATION_STRUCTURE_KHR, ACCELERATION_STRUCTURE_NV,
    SAMPLE_WEIGHT_IMAGE_QCOM, BLOCK_MATCH_IMAGE_QCOM, MUTABLE_EXT
}
...
crate::enum_impl! {
    QueryType : i32, OCCLUSION, PIPELINE_STATISTICS, TIMESTAMP, RESULT_STATUS_ONLY_KHR,
    TRANSFORM_FEEDBACK_STREAM_EXT, PERFORMANCE_QUERY_KHR,
    ACCELERATION_STRUCTURE_COMPACTED_SIZE_KHR,
    ACCELERATION_STRUCTURE_SERIALIZATION_SIZE_KHR,
    ACCELERATION_STRUCTURE_COMPACTED_SIZE_NV, PERFORMANCE_QUERY_INTEL,
    VIDEO_ENCODE_BITSTREAM_BUFFER_RANGE_KHR, MESH_PRIMITIVES_GENERATED_EXT,
    PRIMITIVES_GENERATED_EXT,
    ACCELERATION_STRUCTURE_SERIALIZATION_BOTTOM_LEVEL_POINTERS_KHR,
    ACCELERATION_STRUCTURE_SIZE_KHR, MICROMAP_SERIALIZATION_SIZE_EXT,
...
crate::enum_impl! {
    ...
    FLOAT_CUSTOM_EXT, INT_CUSTOM_EXT
}
...
crate::enum_impl! {
    PipelineBindPoint : i32, GRAPHICS, COMPUTE, RAY_TRACING_KHR, SUBPASS_SHADING_HUAWEI
}
...
crate::enum_impl! {
    IndexType : i32, UINT16, UINT32, NONE_KHR, UINT8_EXT
}
#[doc(alias = "VkFilter")]
...
crate::enum_impl! {
    Filter : i32, NEAREST, LINEAR, CUBIC_EXT
}
...
crate::enum_impl! {
    PolygonMode : i32, FILL, LINE, POINT, FILL_RECTANGLE_NV
}
...
crate::enum_impl! {
    BlendOp : i32, ADD, SUBTRACT, REVERSE_SUBTRACT, MIN, MAX, ZERO_EXT, SRC_EXT, DST_EXT,
    SRC_OVER_EXT, DST_OVER_EXT, SRC_IN_EXT, DST_IN_EXT, SRC_OUT_EXT, DST_OUT_EXT,
    SRC_ATOP_EXT, DST_ATOP_EXT, XOR_EXT, MULTIPLY_EXT, SCREEN_EXT, OVERLAY_EXT,
    DARKEN_EXT, LIGHTEN_EXT, COLORDODGE_EXT, COLORBURN_EXT, HARDLIGHT_EXT, SOFTLIGHT_EXT,
    DIFFERENCE_EXT, EXCLUSION_EXT, INVERT_EXT, INVERT_RGB_EXT, LINEARDODGE_EXT,
    LINEARBURN_EXT, VIVIDLIGHT_EXT, LINEARLIGHT_EXT, PINLIGHT_EXT, HARDMIX_EXT,
    HSL_HUE_EXT, HSL_SATURATION_EXT, HSL_COLOR_EXT, HSL_LUMINOSITY_EXT, PLUS_EXT,
    PLUS_CLAMPED_EXT, PLUS_CLAMPED_ALPHA_EXT, PLUS_DARKER_EXT, MINUS_EXT,
    MINUS_CLAMPED_EXT, CONTRAST_EXT, INVERT_OVG_EXT, RED_EXT, GREEN_EXT, BLUE_EXT
}
...
crate::enum_impl! {
    ...
    G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16, G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16,
    G16_B16R16_2PLANE_444_UNORM, A4R4G4B4_UNORM_PACK16, A4B4G4R4_UNORM_PACK16,
    ASTC_4x4_SFLOAT_BLOCK, ASTC_5x4_SFLOAT_BLOCK, ASTC_5x5_SFLOAT_BLOCK,
    ASTC_6x5_SFLOAT_BLOCK, ASTC_6x6_SFLOAT_BLOCK, ASTC_8x5_SFLOAT_BLOCK,
    ASTC_8x6_SFLOAT_BLOCK, ASTC_8x8_SFLOAT_BLOCK, ASTC_10x5_SFLOAT_BLOCK,
    ASTC_10x6_SFLOAT_BLOCK, ASTC_10x8_SFLOAT_BLOCK, ASTC_10x10_SFLOAT_BLOCK,
    ASTC_12x10_SFLOAT_BLOCK, ASTC_12x12_SFLOAT_BLOCK, PVRTC1_2BPP_UNORM_BLOCK_IMG,
    PVRTC1_4BPP_UNORM_BLOCK_IMG, PVRTC2_2BPP_UNORM_BLOCK_IMG,
    PVRTC2_4BPP_UNORM_BLOCK_IMG, PVRTC1_2BPP_SRGB_BLOCK_IMG, PVRTC1_4BPP_SRGB_BLOCK_IMG,
    PVRTC2_2BPP_SRGB_BLOCK_IMG, PVRTC2_4BPP_SRGB_BLOCK_IMG, R16G16_S10_5_NV
}
...
crate::enum_impl! {
    ...
    ERROR_FRAGMENTATION, ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS, PIPELINE_COMPILE_REQUIRED,
    ERROR_SURFACE_LOST_KHR, ERROR_NATIVE_WINDOW_IN_USE_KHR, SUBOPTIMAL_KHR,
    ERROR_OUT_OF_DATE_KHR, ERROR_INCOMPATIBLE_DISPLAY_KHR, ERROR_VALIDATION_FAILED_EXT,
    ERROR_INVALID_SHADER_NV, ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR,
    ...
    ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT, ERROR_NOT_PERMITTED_KHR,
    ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT, THREAD_IDLE_KHR, THREAD_DONE_KHR,
    OPERATION_DEFERRED_KHR, OPERATION_NOT_DEFERRED_KHR, ERROR_COMPRESSION_EXHAUSTED_EXT
}
...
crate::enum_impl! {
    ...
    DEPTH_BOUNDS, STENCIL_COMPARE_MASK, STENCIL_WRITE_MASK, STENCIL_REFERENCE, CULL_MODE,
    FRONT_FACE, PRIMITIVE_TOPOLOGY, VIEWPORT_WITH_COUNT, SCISSOR_WITH_COUNT,
    VERTEX_INPUT_BINDING_STRIDE, DEPTH_TEST_ENABLE, DEPTH_WRITE_ENABLE, DEPTH_COMPARE_OP,
    DEPTH_BOUNDS_TEST_ENABLE, STENCIL_TEST_ENABLE, STENCIL_OP, RASTERIZER_DISCARD_ENABLE,
    DEPTH_BIAS_ENABLE, PRIMITIVE_RESTART_ENABLE, VIEWPORT_W_SCALING_NV,
    ...
    COVERAGE_MODULATION_TABLE_NV, SHADING_RATE_IMAGE_ENABLE_NV,
    REPRESENTATIVE_FRAGMENT_TEST_ENABLE_NV, COVERAGE_REDUCTION_MODE_NV
}
...
crate::enum_impl! {
    ...
    COMMAND_POOL, SAMPLER_YCBCR_CONVERSION, DESCRIPTOR_UPDATE_TEMPLATE,
    PRIVATE_DATA_SLOT, SURFACE_KHR, SWAPCHAIN_KHR, DISPLAY_KHR, DISPLAY_MODE_KHR,
    DEBUG_REPORT_CALLBACK_EXT, VIDEO_SESSION_KHR, VIDEO_SESSION_PARAMETERS_KHR,
    CU_MODULE_NVX, CU_FUNCTION_NVX, DEBUG_UTILS_MESSENGER_EXT,
    ACCELERATION_STRUCTURE_KHR, VALIDATION_CACHE_EXT, ACCELERATION_STRUCTURE_NV,
    PERFORMANCE_CONFIGURATION_INTEL, DEFERRED_OPERATION_KHR, INDIRECT_COMMANDS_LAYOUT_NV,
    BUFFER_COLLECTION_FUCHSIA, MICROMAP_EXT, OPTICAL_FLOW_SESSION_NV
}
...
crate::bitflags_impl! {
    QueueFlags : u32, 0x17f, GRAPHICS, COMPUTE, TRANSFER, SPARSE_BINDING, PROTECTED,
    VIDEO_DECODE_KHR, VIDEO_ENCODE_KHR, OPTICAL_FLOW_NV
}
...
crate::bitflags_impl! {
    RenderPassCreateFlags : u32, 0x2, TRANSFORM_QCOM
}
...
crate::bitflags_impl! {
    MemoryPropertyFlags : u32, 0x1ff, DEVICE_LOCAL, HOST_VISIBLE, HOST_COHERENT,
    HOST_CACHED, LAZILY_ALLOCATED, PROTECTED, DEVICE_COHERENT_AMD, DEVICE_UNCACHED_AMD,
    RDMA_CAPABLE_NV
}
...
crate::bitflags_impl! {
    ...
    TRANSFER_WRITE, HOST_READ, HOST_WRITE, MEMORY_READ, MEMORY_WRITE, NONE,
    TRANSFORM_FEEDBACK_WRITE_EXT, TRANSFORM_FEEDBACK_COUNTER_READ_EXT,
    TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT, CONDITIONAL_RENDERING_READ_EXT,
    COLOR_ATTACHMENT_READ_NONCOHERENT_EXT, ACCELERATION_STRUCTURE_READ_KHR,
    ACCELERATION_STRUCTURE_WRITE_KHR, FRAGMENT_DENSITY_MAP_READ_EXT,
    FRAGMENT_SHADING_RATE_ATTACHMENT_READ_KHR, COMMAND_PREPROCESS_READ_NV,
...
crate::bitflags_impl! {
    BufferUsageFlags : u32, 0x19bffff, TRANSFER_SRC, TRANSFER_DST, UNIFORM_TEXEL_BUFFER,
    STORAGE_TEXEL_BUFFER, UNIFORM_BUFFER, STORAGE_BUFFER, INDEX_BUFFER, VERTEX_BUFFER,
    INDIRECT_BUFFER, SHADER_DEVICE_ADDRESS, VIDEO_DECODE_SRC_KHR, VIDEO_DECODE_DST_KHR,
    TRANSFORM_FEEDBACK_BUFFER_EXT, TRANSFORM_FEEDBACK_COUNTER_BUFFER_EXT,
    CONDITIONAL_RENDERING_EXT, ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_KHR,
    ACCELERATION_STRUCTURE_STORAGE_KHR, SHADER_BINDING_TABLE_KHR, VIDEO_ENCODE_DST_KHR,
    VIDEO_ENCODE_SRC_KHR, MICROMAP_BUILD_INPUT_READ_ONLY_EXT, MICROMAP_STORAGE_EXT
}
...
crate::bitflags_impl! {
    ...
    PROTECTED, DEVICE_ADDRESS_CAPTURE_REPLAY
}
...
crate::bitflags_impl! {
    ...
    TESSELLATION_EVALUATION, GEOMETRY, FRAGMENT, COMPUTE, ALL_GRAPHICS, ALL, RAYGEN_KHR,
    ANY_HIT_KHR, CLOSEST_HIT_KHR, MISS_KHR, INTERSECTION_KHR, CALLABLE_KHR, TASK_EXT,
    MESH_EXT, SUBPASS_SHADING_HUAWEI
}
...
crate::bitflags_impl! {
    ImageUsageFlags : u32, 0x3cffff, TRANSFER_SRC, TRANSFER_DST, SAMPLED, STORAGE,
    COLOR_ATTACHMENT, DEPTH_STENCIL_ATTACHMENT, TRANSIENT_ATTACHMENT, INPUT_ATTACHMENT,
    VIDEO_DECODE_DST_KHR, VIDEO_DECODE_SRC_KHR, VIDEO_DECODE_DPB_KHR,
    FRAGMENT_DENSITY_MAP_EXT, FRAGMENT_SHADING_RATE_ATTACHMENT_KHR, VIDEO_ENCODE_DST_KHR,
    VIDEO_ENCODE_SRC_KHR, VIDEO_ENCODE_DPB_KHR, ATTACHMENT_FEEDBACK_LOOP_EXT,
    INVOCATION_MASK_HUAWEI, SAMPLE_WEIGHT_QCOM, SAMPLE_BLOCK_MATCH_QCOM
}
...
impl ImageCreateFlags {
    ...
    /// ext_image_2d_view_of_3d
    pub const C2D_VIEW_COMPATIBLE_EXT: Self = Self(1 << 17);
    /// qcom_fragment_density_map_offset
    pub const FRAGMENT_DENSITY_MAP_OFFSET_QCOM: Self = Self(1 << 15);
}
crate::bitflags_impl! {
    ImageCreateFlags : u32, 0x6ffff, SPARSE_BINDING, SPARSE_RESIDENCY, SPARSE_ALIASED,
    ...
    DISJOINT, CORNER_SAMPLED_NV, SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_EXT, SUBSAMPLED_EXT,
    MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_EXT, C2D_VIEW_COMPATIBLE_EXT,
...
crate::bitflags_impl! {
    ImageViewCreateFlags : u32, 0x3, FRAGMENT_DENSITY_MAP_DYNAMIC_EXT,
...
crate::bitflags_impl! {
    SamplerCreateFlags : u32, 0x17, SUBSAMPLED_EXT, SUBSAMPLED_COARSE_RECONSTRUCTION_EXT,
    NON_SEAMLESS_CUBE_MAP_EXT, IMAGE_PROCESSING_QCOM
}
...
impl PipelineCreateFlags {
    ...
    /// ext_pipeline_protected_access
    pub const NO_PROTECTED_ACCESS_EXT: Self = Self(1 << 27);
...
crate::bitflags_impl! {
    ...
    RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_KHR, DEFER_COMPILE_NV,
    CAPTURE_STATISTICS_KHR, CAPTURE_INTERNAL_REPRESENTATIONS_KHR, INDIRECT_BINDABLE_NV,
    LIBRARY_KHR, RETAIN_LINK_TIME_OPTIMIZATION_INFO_EXT, LINK_TIME_OPTIMIZATION_EXT,
    RAY_TRACING_ALLOW_MOTION_NV, COLOR_ATTACHMENT_FEEDBACK_LOOP_EXT,
    DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_EXT, RAY_TRACING_OPACITY_MICROMAP_EXT,
    NO_PROTECTED_ACCESS_EXT, PROTECTED_ACCESS_ONLY_EXT
}
...
crate::bitflags_impl! {
    FormatFeatureFlags : u32, 0x7fffffff, SAMPLED_IMAGE, STORAGE_IMAGE,
    ...
    COSITED_CHROMA_SAMPLES, SAMPLED_IMAGE_FILTER_MINMAX, VIDEO_DECODE_OUTPUT_KHR,
    VIDEO_DECODE_DPB_KHR, ACCELERATION_STRUCTURE_VERTEX_BUFFER_KHR,
    SAMPLED_IMAGE_FILTER_CUBIC_EXT, FRAGMENT_DENSITY_MAP_EXT,
...
crate::bitflags_impl! {
    QueryResultFlags : u32, 0x1f, R64, WAIT, WITH_AVAILABILITY, PARTIAL, WITH_STATUS_KHR
}
...
crate::bitflags_impl! {
    QueryPipelineStatisticFlags : u32, 0x1fff, INPUT_ASSEMBLY_VERTICES,
    ...
    TASK_SHADER_INVOCATIONS_EXT, MESH_SHADER_INVOCATIONS_EXT
}
...
crate::bitflags_impl! {
    ...
    PLANE_2, NONE, MEMORY_PLANE_0_EXT, MEMORY_PLANE_1_EXT, MEMORY_PLANE_2_EXT,
    MEMORY_PLANE_3_EXT
}
...
crate::bitflags_impl! {
    PipelineStageFlags : u32, 0x3ffffff, TOP_OF_PIPE, DRAW_INDIRECT, VERTEX_INPUT,
    ...
    ALL_GRAPHICS, ALL_COMMANDS, NONE, TRANSFORM_FEEDBACK_EXT, CONDITIONAL_RENDERING_EXT,
    ACCELERATION_STRUCTURE_BUILD_KHR, RAY_TRACING_SHADER_KHR,
    FRAGMENT_DENSITY_PROCESS_EXT, FRAGMENT_SHADING_RATE_ATTACHMENT_KHR,
    COMMAND_PREPROCESS_NV, TASK_SHADER_EXT, MESH_SHADER_EXT
}
...
crate::bitflags_impl! {
    DescriptorPoolCreateFlags : u32, 0x7, FREE_DESCRIPTOR_SET, UPDATE_AFTER_BIND,
    HOST_ONLY_EXT
}
...
crate::bitflags_impl! {
    DependencyFlags : u32, 0xf, BY_REGION, DEVICE_GROUP, VIEW_LOCAL, FEEDBACK_LOOP_EXT
}
...
crate::bitflags_impl! {
    DescriptorSetLayoutCreateFlags : u32, 0x7, UPDATE_AFTER_BIND_POOL,
    PUSH_DESCRIPTOR_KHR, HOST_ONLY_POOL_EXT
}
...
crate::bitflags_impl! {
    SubpassDescriptionFlags : u32, 0xff, PER_VIEW_ATTRIBUTES_NVX,
    PER_VIEW_POSITION_X_ONLY_NVX, FRAGMENT_REGION_QCOM, SHADER_RESOLVE_QCOM,
    RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_EXT,
    RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_EXT,
    RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_EXT, ENABLE_LEGACY_DITHERING_EXT
}
...
crate::bitflags_impl! {
    PipelineLayoutCreateFlags : u32, 0x2, INDEPENDENT_SETS_EXT
}
...
crate::bitflags_impl! {
    PipelineColorBlendStateCreateFlags : u32, 0x1,
...
crate::bitflags_impl! {
    PipelineDepthStencilStateCreateFlags : u32, 0x3,
    RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_EXT,
...
crate::bitflags_impl! {
    InstanceCreateFlags : u32, 0x1, ENUMERATE_PORTABILITY_KHR
}
#[track_caller]
