...
crate::bitflags_impl! {
    ToolPurposeFlags : u32, 0x1f, VALIDATION, PROFILING, TRACING, ADDITIONAL_FEATURES,
    MODIFYING_FEATURES
}
...
crate::bitflags_impl! {
    AccessFlags2 : u64, 0x3cff0001ffff, NONE, INDIRECT_COMMAND_READ, INDEX_READ,
    ...
    VIDEO_ENCODE_WRITE_KHR, INVOCATION_MASK_READ_HUAWEI, MICROMAP_READ_EXT,
    MICROMAP_WRITE_EXT, OPTICAL_FLOW_READ_NV, OPTICAL_FLOW_WRITE_NV
}
...
crate::bitflags_impl! {
    PipelineStageFlags2 : u64, 0x1ff7c01ffff, NONE, TOP_OF_PIPE, DRAW_INDIRECT,
    ...
    VIDEO_DECODE_KHR, VIDEO_ENCODE_KHR, SUBPASS_SHADING_HUAWEI, INVOCATION_MASK_HUAWEI,
