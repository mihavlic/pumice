...
crate::enum_impl! {
    PresentModeKHR : i32, IMMEDIATE, MAILBOX, FIFO, FIFO_RELAXED, SHARED_DEMAND_REFRESH,
...
crate::enum_impl! {
    ColorSpaceKHR : i32, SRGB_NONLINEAR, DISPLAY_P3_NONLINEAR_EXT,
    EXTENDED_SRGB_LINEAR_EXT, DISPLAY_P3_LINEAR_EXT, DCI_P3_NONLINEAR_EXT,
    BT709_LINEAR_EXT, BT709_NONLINEAR_EXT, BT2020_LINEAR_EXT, HDR10_ST2084_EXT,
