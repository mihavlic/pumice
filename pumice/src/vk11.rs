...
impl SubgroupFeatureFlags {
    ...
    pub const PARTITIONED_NV: Self = Self(1 << 8);
}
crate::bitflags_impl! {
...
crate::bitflags_impl! {
    ExternalMemoryHandleTypeFlags : u32, 0x1fff, OPAQUE_FD, OPAQUE_WIN32,
    OPAQUE_WIN32_KMT, D3D11_TEXTURE, D3D11_TEXTURE_KMT, D3D12_HEAP, D3D12_RESOURCE,
